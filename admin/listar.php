...
<a href="index.php" class="btn m-3 btn-outline-purple float-right section-padding devider justify-content-center" >Voltar</a>
 <!-- Hero -->
 <div id="hero" class="section-padding devider">
        <div class="container">
            <div class="row gy-4 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <center><h1 class="text-white">Lista de Contatos</h1></center>
                    <p class="landing-content-desc mt-3" style="text-align: center"></p>     
  ...
  <div class="container">
    <div id="sobre" class="section-padding devider">
        <div class="container">
        <a href="salvar.php" class="btn btn-outline-purple float-right justify-content-right" > <i class="bi bi-arrow-left"> voltar</i></a>
            <div class="row gy-4 align-items-center">
            <table class="table">
  <thead>
    <tr>
...
?>
        ...
        <td class="text-white"><?= $mostrar['email']?></td>
        <td class="text-white"><?= $mostrar['mensagem']?></td>
        <td>
        <a href="salvar.php" class="btn btn-purple">
        <i class='bx bx-edit-alt' ></i>
                    </a>
                    <a href="?p=excluir&id=<?= $chave ?>" class="btn btn-purple" data-confirm="Excluir"> 
